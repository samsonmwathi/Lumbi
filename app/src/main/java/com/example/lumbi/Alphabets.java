    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            ...
            case R.id.a:
                ...
                image.setImageResource(R.drawable.card_a);
            ...
            case R.id.b:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_b);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.c:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_c);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.d:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_d);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.e:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_e);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.f:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_f);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.g:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_g);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.h:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_h);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.i:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_i);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.j:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_j);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.k:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_k);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.l:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_l);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.m:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_m);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.n:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_n);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;case R.id.o:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_o);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.p:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_p);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.q:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_q);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.r:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_r);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.s:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_s);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.t:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_t);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            ...
            case R.id.u:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_u);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.v:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_v);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.w:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_w);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.x:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_x);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            case R.id.y:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_y);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
            ...
            case R.id.z:
                ...
                view=factory.inflate(R.layout.display, null);
                image= (ImageView) view.findViewById(R.id.display);
                image.setImageResource(R.drawable.card_z);
                builder.setView(view);
                builder.setNeutralButton("BACK",null);
                builder.show();
                break;
